...
export function LoginForm() {
  ...
  return (
    <div className="w-full max-w-[380px] sm:max-w-[460px] mx-auto py-10 sm:py-16 px-4">
      {/* Title */}
      <h1 className="text-[32px] sm:text-[38px] font-medium text-black tracking-tight text-center mb-1.5">
        Log In
      </h1>

      {/* Subtitle with Switch Link */}
      <p className="text-responsive-lg text-neutral-600 text-center mb-8">
