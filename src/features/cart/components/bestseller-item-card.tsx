...
export function BestsellerItemCard({ product }: BestsellerItemCardProps) {
  ...
  return (
    <div className="flex items-center justify-between gap-3 sm:gap-4 py-1 group">
      ...
      <div className="relative size-[90px] xs:size-[100px] sm:size-[110px] shrink-0 overflow-hidden bg-[#f4f4f4] rounded-sm flex items-center justify-center">
        <Image
          src={product.image}
      ...
      <div className="flex-1 min-w-0 pr-1 sm:pr-2">
        <h4 className="text-[14px] sm:text-[16px] font-semibold text-black tracking-tight line-clamp-1">
          {product.name}
        </h4>
