  ...
  return (
    ...
    >
      <div className="relative w-full border-b border-border bg-white">
        <div className="mx-auto flex h-[70px] w-full max-w-[1585px] min-w-0 items-center justify-between px-3 sm:px-4 md:px-6 lg:px-8 lg:grid site-header-grid">
          ...
          <Link
            href="/"
            className="hidden h-full min-w-0 max-w-full items-center justify-center border-x-0 xl:border-x xl:border-border px-2 sm:px-4 lg:px-8 xl:px-[70px] text-center text-[24px] xl:text-[34px] 2xl:text-[28px] lg:flex"
            style={{ fontFamily: "var(--font-monument)" }}
            aria-label="Verstivo home"
          >
          ...
          <div className="flex h-full min-w-0 items-center justify-end">
            ...
            <button
              type="button"
              className={`${iconButtonClassName} hidden w-[85px] lg:grid 2xl:w-[100px]`}
              aria-label="Account"
            >
