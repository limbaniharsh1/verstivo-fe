              ...
              <div key={group.title} className="flex flex-col min-w-0">
                ...
                <ul className="mt-4 space-y-1">
                  {group.links.map((link) => {
                    const isLoginRegister = link.label === "Login/Register";
